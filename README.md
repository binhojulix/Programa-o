...
5.  [Test Driver Development](#math-tools)
6.  [Algoritimos](#machine-learning)
7.  [Java Para Web](#natural-language-processing)
8.  [Teoria dos Grafos](#computer-vision)
9.  [Estrutura de dados](#time-series)
10. [Programção Paralela](#feature-engineering)
11. [Programação Concorrente](#visualization)
12. [Persistencia de dados](#mathematical-programming)
13. [Spring boot](#scraping)
14. [Microserviços](#python)
15. [AWS](#terminal)
